...
- QhboxLayout - Stacks widgets vertically (top to bottom)
- WHBoxLayout - Places widgets horizontally
- QGridLayout - Arranges widgets in a grid of rows and columns
"""
import sys
from PyQt5.QtWidgets import QLabel, QWidget,QHBoxLayout,QGridLayout, QMainWindow, QApplication
...
class MainWindow(QMainWindow):
    ...
    def initUI(self):
        ...
        #Labels don't show up because I didn't specify a parent container
